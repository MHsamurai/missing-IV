...
PDFはGit管理外であるため、この索引でローカルファイル名、書誌、研究上の役割を管理する。
...
| File | Reference | Main role |
|---|---|---|
| `Li_Miao_Shpitser_TchetgenTchetgen_2023_Self_Censoring_Multivariate_MNAR.pdf` | Li, Miao, Shpitser and Tchetgen Tchetgen (2023), *Biometrics* | multivariate nonmonotone MNARのself-censoring model |
| `Li_Shao_2022_Panel_Item_Nonresponse.pdf` | Li and Shao (2022), *Statistical Theory and Related Fields* | panel dataのnonignorable item nonresponse |
| `Malinsky_Shpitser_TchetgenTchetgen_2022_No_Self_Censoring.pdf` | Malinsky, Shpitser and Tchetgen Tchetgen (2022), *JASA* | no-self-censoring modelのsemiparametric inference |
| `Miao_Liu_TchetgenTchetgen_Geng_2019_Shadow_Variable_Working_Paper.pdf` | Miao, Liu, Tchetgen Tchetgen and Geng (2019 version), arXiv:1509.02556 | shadow variableによる識別、doubly robust推定、効率理論のworking paper版 |
| `Ni_Shao_2023_Multivariate_Outcomes_Item_Nonresponse.pdf` | Ni and Shao (2023), *Annals of the Institute of Statistical Mathematics* | multivariate outcomeのnonignorable item nonresponseとIPW |
| `Sadinle_Reiter_2017_ICIN_Multivariate_Data.pdf` | Sadinle and Reiter (2017), *Biometrika* | itemwise conditionally independent nonresponse (ICIN) model |
...
`Miao_Liu_TchetgenTchetgen_Geng_2019_Shadow_Variable_Working_Paper.pdf`は、2019年9月版の
arXiv working paperである。2024年の*ACM/IMS Journal of Data Science*刊行版はYilin Liが
著者に加わり、題名も一部変更されているため、同一ファイルとして扱わない。
