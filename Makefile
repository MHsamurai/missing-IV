...
WORKING_TEX := notes/vector_missing_iv_identification_working.tex
WORKING_PDF := build/formal/vector_missing_iv_identification_working/vector_missing_iv_identification_working.pdf
