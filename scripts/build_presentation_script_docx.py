...
SLIDES = [
    ...
    ("Two marginal views of the model", [
        ...
        "下は、Fとblock外の項目について平均した図です。Z SからY S、Y SからR Sへ矢印を引いています。Y SとU Sが決まると、Z SとR Sが独立になる関係です。ここでいうfull-data lawは、回答者だけでなく、欠測した人も含む母集団の分布です。図にY Sがあっても、全員で見えているという意味ではありません。",
    ...
    (
        ...
        [
            "ここからシミュレーションです。Xは固定し、Fは二つのクラスとします。図の下は、Z SからY S、Y SからR Sという流れです。FからZ Sへも矢印があります。FとZ Sは関連するので、ここを独立にしてはいけません。Wと三つのYは全て二値です。Y 1はいつも見えているので、ペアが全部見えるかどうかは、もう一方のD jで決まります。",
